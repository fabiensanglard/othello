...
/*consilent fournit le caract�re pr�sent s'il y en a un, le caract�re nul sinon*/

char consilent(void);

/***********************************************************************/

/*bouton fournit le num�ro de bouton si un bouton de la souris a �t� enfonc�, 0 sinon*/
